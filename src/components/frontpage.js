...
export default function Frontpage() {
  ...
  return (
    <Fragment>
      ...
      <Image id="iimag" src={FrontImage} alt=""/>
      <p>Cathy Events is a premier event management company based in Chennai that specializes in creating unforgettable experiences for our clients. Our team of dedicated professionals is committed to providing exceptional service and attention to detail, ensuring that every event we plan is a success.</p>
       ...
       <p>In addition to our event planning services, we also offer event rentals, including Furniture, Lightings, Photography, Fun Zone, Surprise Party, LED Walls, Cake Decor, Catering Services, Bouquet, DJ & Audio, Corporate Events, Return Gifts, and Venue. Our extensive inventory of professional-grade equipment ensures that every event we plan is of the highest quality, with no detail left unattended. We offer competitive pricing that is within budget without sacrificing the quality of our services. Our personalized approach ensures that our clients get the best value for their event.

Contact Cathy Events today to see how we can bring your vision to life and help create an unforgettable event!</p>
